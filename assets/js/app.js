...
function App() {
  ...
  function _unfurlAndPin() {
    _unfurlAndPin = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(H, dur) {
  ...
  function _runScriptA() {
    _runScriptA = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
      var prev;
  ...
  function _runScriptB() {
    _runScriptB = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
      var prev;
  ...
  function playScene(_x3) {
    return _playScene.apply(this, arguments);
  }
  /* ---------- 构建楼层 ---------- */
  function _playScene() {
    _playScene = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(scene) {
      var _t;
  ...
  }), ReactDOM.createPortal(/*#__PURE__*/React.createElement(ConsolePanel, {
    ctx: ctx,
    setCtx: _setCtx,
    open: consoleOpen,
